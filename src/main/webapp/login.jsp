				...
				<div class="row navigation">
					<div class="span12">
						<ul class="nav nav-tabs">
							<li><a href="menu1.jsp">Topicos 1</a></li>
		...
		<div class="container content">
			<div class="row">
				<div class="span8 leftContent">
					...
					<div class="row">
						<div class="span4">
							<p class="cntPara simpleDesign" align="justify">
								<strong class="lead">Titulo caixa 1</strong> Conteúdo caixa 1
							</p>
						</div>

						<div class="span4">
							<p class="cntPara itsFree" align="justify">
								<strong class="lead">Título caixa 2</strong> Conteúdo caixa 2
							</p>
						</div>
					</div>
					<hr />
					<div class="row">
						<div class="span4">
							<p class="cntPara secureApp" align="justify">
								<strong class="lead">Título caixa 2</strong> conteúdo caixa 3
						</div>
					...
					<div class="row">
						<div class="span8">
							<h3 class="quickTour">wwww.academia.com.br</h3>
							conteúdo rodapé
						</div>
					</div>
				</div>
